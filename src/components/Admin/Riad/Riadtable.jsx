...
// import RoomsModal from '../../Modal/RoomsModal';
...
//   useEffect(() => {
//     if (Array.isArray(riads['hydra:member'])) {
...
//           <div className="text-lg font-semibold text-gray-900">Riads</div>
...
//                   <thead>
//                     <tr>
//                       <th className="whitespace-nowrap py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-0">Riad ID</th>
...
//                       <th className="whitespace-nowrap px-2 py-3.5 text-left text-sm font-semibold text-gray-900">Address</th>
//                       <th className="whitespace-nowrap px-2 py-3.5 text-left text-sm font-semibold text-gray-900">City</th>
                    ...
                    {filteredRiads.map((riad) => (
                      <React.Fragment key={riad.id}>
                        <tr>
                          ...
                          <td className="relative whitespace-nowrap py-2 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                            <button
                              onClick={() => toggleDropdown(riad.id)}
                              className="text-blue-600 hover:text-blue-900 ml-2"
                              aria-label={`Open dropdown for Riad ${riad.id}`}
                            >
                              Options
                            </button>
