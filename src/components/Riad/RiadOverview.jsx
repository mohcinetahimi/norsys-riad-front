...
import RoomList from '../Riad/RoomList.jsx';
import ReservationForm from '../Profil/ReservationForm.jsx';
...
const riads = [
    {
        ...
        description:
            'Riad Dar Al Hossoun is a beautiful traditional Moroccan guesthouse located in the heart of Marrakech. Enjoy the tranquil garden, refreshing pool, and authentic decor.',
    ...
    return (
        <div className="bg-white">
            <div className="pt-6">
                    ...
                    <div className="mt-4 lg:row-span-3 lg:mt-0">
                        ...
                        <div className="mt-6">
                            ...
                            <div className="flex items-center">
                                ...
                                <p className="sr-only">
                                    {riad.reviews.average} out of 5 stars
                                </p>
                                <a
                                    href={riad.reviews.href}
                ...
                <RoomList onBookNow={handleBookNow}/>
            </div>
            {selectedRoom && <ReservationForm room={selectedRoom} onClose={handleCloseForm}/>}
        </div>
    );
}
//with rooms
